...
const FarcasterResolverMockModule = buildModule("FarcasterResolverMockModule", (m) => {
  ...
  const publicKeyVerifier = m.contract("FarcasterPublicKeyVerifierMock", [], {});
...
export default FarcasterResolverMockModule;
